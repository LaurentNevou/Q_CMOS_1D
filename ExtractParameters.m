...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Energy level of the band 6c at the X point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'EgX');
  if idx==1
    idx_EgX = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bandgap Temperature dependency parameter "alpha" at the X point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'alphaX');
  if idx==1
    idx_alphaX = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bandgap Temperature dependency parameter "beta" at the X point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'betaX');
  if idx==1
    idx_betaX = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Energy level of the band 6c at the L point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'EgL');
  if idx==1
    idx_EgL = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bandgap Temperature dependency parameter "alpha" at the L point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'alphaL');
  if idx==1
    idx_alphaL = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Bandgap Temperature dependency parameter "beta" at the L point

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'betaL');
  if idx==1
    idx_betaL = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% electron mass for the 1band Schrodinger solver and Poisson Solver
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% heavy hole mass for the Poisson Solver
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% light hole mass for the Poisson Solver

for i=1:length(DB.textdata(:,1))
  idx=strcmp(DB.textdata{i,1},'mlh');
  if idx==1
    idx_mlh = i-1;
    % break % removing the break makes it slower but more compatible between Matlab and Octave
  end
...
%for i=1:length(DB.textdata(:,1))
%  idx=strcmp(DB.textdata{i,1},'muN');
%  if idx==1
%    idx_muN = i-1;
%    % break % removing the break makes it slower but more compatible between Matlab and Octave
%  end
...
%for i=1:length(DB.textdata(:,1))
%  idx=strcmp(DB.textdata{i,1},'muP');
%  if idx==1
%    idx_muP = i-1;
%    % break % removing the break makes it slower but more compatible between Matlab and Octave
%  end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Tau carrier recombinaison time

%for i=1:length(DB.textdata(:,1))
%  idx=strcmp(DB.textdata{i,1},'Tau');
%  if idx==1
%    idx_Tau = i-1;
%    % break % removing the break makes it slower but more compatible between Matlab and Octave
%  end
